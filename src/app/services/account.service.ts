...
export class AccountService {
  ...
  public get stocks(): Stock[] {return this._stocks;}
  ...
  private cacheValues(){
    ...
    this.localStorageService.set('balance',this.balance,defaultBalance);
    this.localStorageService.set('cost',this.cost,0);
  }
